...
# HANDLE TAROH DISINI BANG SAFE_POST
...
def main():
    ...
    print("\r Mendapatkan list FAKE TECH BD valid...", end="", flush=True)
    ...
    while True:
        ...
        # Kumpulkan informasi shohag vaii terlebih dahulu
        ...
        print("\rList Rejaul → ACCOUNT:                                   ", flush=True)
        ...
        # Setelah menampilkan Rejaul, mulai memeriksa tugas
        ...
        for index, result, first_name, last_name, league in accounts:
            ...
            if stat_result is not None:
                ...
                output = (
                    ...
                    f"[ Rejaul →{index + 1} - {first_name} {last_name} ]\n"
                ...
                if energy_sekarang < 0.25 * user_data['maxEnergy']:
                    ...
                    if auto_booster == 'y':
                        ...
                        if user_data['freeBoosts']['currentRefillEnergyAmount'] > 0:
                            ...
                            continue  # Beralih ke SHOHAG VAII berikutnya
        ...
        print("=== [ Rejaulakash BY PROSESING ] ===")
